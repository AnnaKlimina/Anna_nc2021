...
async function createMajorPage() {
  ...
  let response = await fetch(
    "https://my-library-project-server.herokuapp.com/main_page_news"
  );
  if (response.ok) {
  ...
  response = await fetch(
    "https://my-library-project-server.herokuapp.com/popular_books_main_page"
  );
  if (response.ok) {
  ...
  response = await fetch(
    "https://my-library-project-server.herokuapp.com/new_books_main_page"
  );
  if (response.ok) {
    let books = await response.json();
    fillBookContainer(
